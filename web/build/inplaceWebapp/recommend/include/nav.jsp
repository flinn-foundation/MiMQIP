...
//if (is_authenticated()) {
	...
	while(it.hasNext())
	{
		...
		if (AdminFunctions.has_role(role, nav_role.get(0)) || AdminFunctions.has_role(role, nav_role.get(1))) {
	    	...
	    	out.print("'><img src='/recommend/images/s.gif' width=5 height=15 alt='' border='0'><img src='/recommend/images/nav_boxed_arrow.gif' width=25 height=15 alt='' border='0'><img src='/recommend/images/s.gif' width=8 height=15 alt='' border='0'>"+nav_section_al.get(0)+"</a></td></tr>\n");
	    	...
	    	if (admin_section.equals(navkey) && nav_section_al.get(0).equals("id")) {
	    	 	...
	    	 	while(ital.hasNext())
	    		{
	    	        ...
	    	        if (admin_subsection.equals(subnav) && hasID) {
	    	        	...
	    	        	out.print("'><img src='/recommend/images/s.gif' width=45 height=15 alt='' border='0'><img src='/recommend/images/nav_drop_arrow.gif' width=25 height=15 alt='' border='0'><img src='/recommend/images/s.gif' width=8 height=15 alt='' border='0'>"+title+"</a></td></tr>\n");
	    	        	out.print("<tr bgColor='#FFFFFF'><td height='1'><img src='/recommend/images/s.gif' width=1 height=1 alt='' border='0'></td></tr>\n");
	    	        }
	    	        alCount++;
	    	    }	    	  			
...
%>
<tr valign="middle">
        <td><span class="navLink"><img src="/recommend/images/s.gif" width=5 height=50 alt="" border="0"></span></td>
</tr>
<tr bgColor="#FFFFFF">
        <td height="1"><img src="/recommend/images/s.gif" width=1 height=1 alt="" border="0"></td>
</tr>
<tr valign="middle">
<td><a href="/admin/index.jsp" class="navLink"><img src="/recommend/images/s.gif" width=5 height=15 alt="" border="0"><img src="/admin/images/nav_boxed_arrow.gif" width=25 height=15 alt="" border="0"><img src="/admin/images/s.gif" width=8 height=15 alt="" border="0">Admin Home</a></td>
</tr>
<tr bgColor="#FFFFFF">
<td height="1"><img src="/recommend/images/s.gif" width=1 height=1 alt="" border="0"></td>
</tr>
