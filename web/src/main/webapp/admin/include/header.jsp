...
<html>
<head>
        <title>Flinn Foundation Administration Tool</title>
...
<tr>
        ...
        <td><img src="images/s.gif" width=1 height=1 alt="" border="0"></td>
...
<img src="images/s.gif" width=186 height=1 alt="" border="0"></p>
        ...
        <td width=1 bgColor="#E6E5E3"><img src="/s.gif" width=1 height=1 alt="" border="0"></td>
        <td><jsp:include page="/admin/include/crumb.jsp">
