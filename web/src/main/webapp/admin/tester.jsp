...
if (authcode == null || authcode.equals("")){ 
	...
	flinn.beans.response.ResponseSessionContainerBean userSession = (new flinn.dao.DaoAppManager()).getSession(authcode, request);
	if (userSession != null){	
...
<jsp:include page="include/tester.jsp" />
</div>
	</td>
