				...
				<ul class="radioList">
					<li>
						<div class="floatWrapper">
							<input type="radio" id="stage1" value="I know the stage" name="stage" /> <label id="stageLabel" for="stage1">I know the patient's stage. </label>
						</div>
					...
					<li>
						<div class="floatWrapper"><input type="radio" id="stage2" value="I know the medication" name="stage" /> <label for="stage2">I don't know the patient's stage, but I know the medications the patient has recently responded to.</label></div>
					</li>
					<li>
						<div class="floatWrapper"><input type="radio" id="stage3" value="I don't know" name="stage" /> <label for="stage3">I don't know the patient's stage and I don't know the medications the patient has recently responded to.</label></div>
					</li>
				</ul>			
			</li>
		</ul>
