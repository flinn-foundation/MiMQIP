...
<%
String admin_section = "Manage Treatment";
String admin_subsection = "Treatment";
String sub_section = "";
String userlogin = "u";
String role = "r";
int roleid = -1;
    ...
    <body leftmargin=0 topmargin=0 bgcolor="#ffffff">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr valign="top" bgColor="#7F7F7F">
                <td><p class="pageTitle"><span class="pageHeader">Treatment</span></p></td>
            </tr>
	</table>
...
<jsp:include page="include/treatment_detail.jsp" />
</div>
	</td>
</tr>
</table>
